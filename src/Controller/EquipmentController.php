...
/*        $equipment->setImage("https://previews.123rf.com/images/lightwise/lightwise1301/lightwise130100068/17472622-sports-equipment.jpg");*/
    ...
    public function indexQr(BuilderInterface $qrbuilder ,Equipment $eq): Response
    {
...
//     public function rateEquipment(Request $request, Equipment $equipment)
// {
...
//         return new JsonResponse(['error' => 'Invalid rating value'], Response::HTTP_BAD_REQUEST);
//     }

//     // Get the current user
//     $user = $this->getUser();

//     // Check if the user has already rated the equipment
//     $existingRating = $this->getDoctrine()->getRepository(Rating::class)->findOneBy(['user' => $user, 'equipment' => $equipment]);
...
//     return new JsonResponse(['message' => 'Equipment rated successfully'], Response::HTTP_OK);
// }
/**
 * @Route("/rate/{id}", name="equipment_rate", methods={"POST"})
 */
// public function rate(Request $request, Equipment $equipment)
// {
...
// }
// public function get_average_rating_for_equipment($equipmentId)
// {
