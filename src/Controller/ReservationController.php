...
class ReservationController extends AbstractController
{
    ...
    public function paymentSuccess(Reservation $reservation, Client $twilio): Response
    {
        ...
        $message = $client->messages->create(
            ...
            [
                'from' => $twilioNumber,
                'body' => '-Sportify : Thank you for making a reservation with us! We look forward to seeing you on'. $reservation->getDateReservation()->format('m/d/Y') . ' at ' . $reservation->getStartTime()->format('h:i A') . '.',
            ]
        );
